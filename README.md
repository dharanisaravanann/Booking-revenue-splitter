...
2. The app cleans column names, converts Arrival/Departure/Booking Date to proper date format, expands each booking into individual stay dates, and computes nightly revenue
3. Download the resulting Excel file with daily-level entries
